// 화면 맨 위 "오늘의 목표" 두 칸 — 이 연습이 언제 끝나는지를 단계 번호 대신 학습 목표로 말한다
 ...
 *
 * 두 칸은 원래 `ExitJourneyGuide` 맨 아래에 묻혀 있어 스크롤해야 보였다. 끝나는 조건이 화면에서
 * 가장 늦게 보이면 "내가 뭘 한 거고 언제 끝나는 거지"가 된다 — 그래서 맨 위로 올렸다.
 */
    ...
    <section aria-label="오늘의 목표" className="rounded-2xl border border-line bg-elevated/60 px-4 py-3">
      <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
        ...
        <p className="text-[11px] text-muted">
          {allDone ? '둘 다 채웠습니다 — 이제 마무리할 수 있어요' : '둘 다 채우면 끝납니다'}
        </p>
