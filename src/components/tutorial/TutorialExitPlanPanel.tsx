...
export function TutorialExitPlanPanel({
   ...
   *
   * **이 화면에서 "감정 대 규칙"이 가장 잘 보이는 자리다**(2026-08-21 튜터 피드백). 예전에는 제약을
   * 사실로만 말했는데("다시 걸 수 없습니다"), 규칙이 무너지는 방식은 정확히 *손실 중에 손절선을
   * 슬금슬금 내리는 것*이다. 그래서 사용자가 지금 느끼는 것을 먼저 이름 붙이고, 잠그는 이유가 그
   * 감정이라는 것을 말한다 — 알아준 다음에 막아야 설득이 된다.
   */
