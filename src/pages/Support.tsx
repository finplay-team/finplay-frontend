...
const faqs = [
  ...
  {
    q: '시세 날짜가 오늘이 아닌데 왜 그런가요?',
    a: '오늘의 실시간 시세가 아니라 과거 거래일에 기록된 1분봉을 순서대로 다시 재생합니다. 그래서 화면에 재생 중인 원본 거래일을 함께 표시합니다. 움직임은 실제 있었던 값이지만 오늘 가격은 아닙니다.',
  },
  {
    q: '지금 주문이 되지 않습니다.',
    a: '주문은 평일 09:00~15:30에만 가능합니다. 그 시간이라도 해당 종목의 시세를 받을 수 없으면 주문할 수 없습니다. 어느 쪽인지 화면에 사유가 표시되니 함께 확인해 주세요.',
  },
  {
  ...
  {
    q: '수수료는 어떻게 계산되나요?',
    a: '수수료는 서버가 계산해 체결 결과에 반영합니다. 주식은 체결 금액의 0.015%이며, 화면에서 따로 어림해 보여주는 값이 아닙니다.',
  },
  {
    q: '시드머니와 수익률 기준은 무엇인가요?',
    a: '가입하면 주식 계좌에 가상 시드머니 1,000만원이 지급됩니다. 수익률은 (평가자산 − 시드머니) ÷ 시드머니 로 계산하며, 실현손익과 미실현손익을 함께 확인할 수 있습니다.',
  },
  {
    q: '차트에 분봉이 보이지 않습니다.',
  ...
  {
    q: '코인도 거래할 수 있나요?',
    a: '아니요. 현재는 주식만 거래할 수 있습니다. 화면에 코인 시장은 노출되지 않습니다.',
  },
  {
